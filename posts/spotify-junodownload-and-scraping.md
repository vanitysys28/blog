...
Listening to music of all kind is made really easy nowadays thanks to streaming platforms like Spotify. Anyone can find their favorite music and sort it in playlist based on their tastes or categories they see fit. An algorithm is also nicely trained to make us discover brand new songs through the [recommendations](https://www.spotify.com/mt/safetyandprivacy/understanding-recommendations) or the [radio](https://community.spotify.com/t5/FAQs/Spotify-Radio-how-does-it-work/ta-p/4757060) feature.

Everything is great until the algorithm isn't able to offer exactly the kind of music you are looking for. Sometimes, it is even simply showcasing songs coming from albums that are already in your playlists, or were previously searched for. In that situation, it's becoming harder to discover unpopular new releases and to populate a playlist that might become stale after hundreds of hours of listening, and being forwarded the same songs even on [shuffle](https://www.reddit.com/r/spotify/comments/10k9b84/should_shuffle_mode_be_100_random/).

Some websites are great sources to discover new releases for precise genres. [Junodownload](https://www.junodownload.com/) is one of them when it comes to electronic music, and the [new releases page](https://www.junodownload.com/all/this-week/releases/) makes it a breeze to find brand new music for your tastes. Seeing the amount of brand new songs I could add to my playlists and discover, I needed to find a way to feed them to Spotify quick and easy.

Python would be a great tool for the job, and the [Beautiful Soup](https://www.crummy.com/software/BeautifulSoup/) library would help me scrape the precious data I needed. After prompting the user for the genre they prefer, and their desired time span, getting the information was as easy as this:
